export default [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes', name: '_resultData', type: 'bytes' },
    ],
    name: 'Call',
    type: 'event',
  },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'bytes', name: 'oldAddress', type: 'bytes' },
  ...
  {
    inputs: [{ internalType: 'bytes', name: 'accountImplementaion_', type: 'bytes' }],
  ...
  {
    inputs: [{ internalType: 'address', name: 'deusV3Address_', type: 'address' }],
    name: 'setDeusV3Address',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
